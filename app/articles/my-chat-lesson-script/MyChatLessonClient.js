    ...
    <div className="relative min-h-screen font-sans bg-neutral-bg dark:bg-neutral-bg-dark transition-colors duration-500">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-3 sm:px-6 lg:px-8 py-4 md:py-6 lg:py-8">
        ...
        <motion.div
          ...
          className="bg-card-bg dark:bg-card-bg-dark backdrop-blur-sm rounded-xl border border-card-border dark:border-card-border shadow-xl p-3 sm:p-6 mb-8"
        >
        ...
        <motion.div
          ...
          className="mt-12 pt-8 border-t border-card-border dark:border-card-border"
        >
